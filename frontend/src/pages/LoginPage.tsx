  ...
  return (
    <div className="min-h-screen w-full bg-slate-50 text-slate-800 flex items-stretch">
      <div className="w-full grid grid-cols-1 lg:grid-cols-12 min-h-screen">
        ...
        <div className="lg:col-span-6 xl:col-span-5 flex flex-col justify-between p-5 sm:p-10 lg:p-12 bg-white z-10 animate-modal-pop shadow-2xl">
          
          {/* Top Brand Logo Header (Desktop & Mobile) */}
          ...
          {/* MOBILE HERO CARD HEADER (VISIBLE ONLY ON MOBILE) */}
          <div className="lg:hidden p-4 rounded-3xl bg-gradient-to-r from-slate-900 via-brand-950 to-brand-900 text-white shadow-lg space-y-2 mb-4 relative overflow-hidden">
            <div className="flex items-center justify-between">
              <span className="text-[9px] font-extrabold uppercase text-amber-300 tracking-widest bg-amber-500/20 px-2.5 py-0.5 rounded-full border border-amber-500/30">
                PORTAL RESMI PRESENSI
              </span>
              <span className="text-[9px] font-bold text-emerald-400">✓ Aktif 24/7</span>
            </div>
            <div className="text-sm font-extrabold text-white">Sistem Absensi Guru & Kepala Sekolah</div>
            <p className="text-[10px] text-slate-300 font-medium">Validasi Geofencing GPS & Selfie Wajah Kedinasan</p>
          </div>

          {/* Centered Login Box */}
          <div className="w-full max-w-sm mx-auto my-auto space-y-5 sm:space-y-6">
            
            {/* Header Icon & Titles */}
            <div className="space-y-1.5 sm:space-y-2">
              <div className="inline-flex p-2.5 sm:p-3 rounded-2xl bg-brand-500 text-white shadow-lg shadow-brand-500/30 mb-1">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-4 py-3 pl-10 text-xs font-bold text-slate-900 placeholder-slate-400 focus:outline-none focus:bg-white focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 transition"
                  />
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-4 py-3 pl-10 pr-10 text-xs font-bold text-slate-900 placeholder-slate-400 focus:outline-none focus:bg-white focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 transition"
                  />
              ...
              <div className="flex items-center justify-between text-xs pt-1">
                ...
                <div className="flex items-center gap-3">
                  <button
                    ...
                    className="text-brand-600 hover:text-brand-700 font-extrabold text-[11px] flex items-center gap-1 hover:underline transition"
              ...
              <button
                ...
                className="w-full mt-2 bg-brand-500 hover:bg-brand-600 disabled:opacity-50 text-white font-extrabold py-3.5 rounded-2xl transition flex items-center justify-center gap-2 text-xs shadow-lg shadow-brand-500/30"
              >
                {isSubmitting ? (
          ...
          {/* Footer Contact */}
          <div className="text-[11px] text-slate-400 flex items-center justify-between border-t border-slate-100 pt-3 font-semibold">
